    ...
    <div className="min-h-screen bg-white text-[#111] font-sans selection:bg-black selection:text-white">
      ...
      <main>
        ...
        <section className="w-full bg-white py-16 sm:py-24">
          <div className="w-full max-w-[1600px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20">
            <div className="p-10 sm:p-14 bg-[#111] text-white rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="space-y-2 text-center md:text-left max-w-2xl">
                ...
                <p className="text-gray-400 font-sans text-xs sm:text-sm leading-relaxed">
                  Consult with our acoustic engineers today. We review blueprints, evaluate sound transmission benchmarks, and deliver turnkey solutions.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 shrink-0">
                <button
                  onClick={() => setIsQuoteModalOpen(true)}
                  className="px-8 py-3.5 bg-white hover:bg-gray-100 text-black font-sans text-xs font-bold uppercase tracking-wider rounded-full shadow-lg transition-all active:scale-95 cursor-pointer"
                >
